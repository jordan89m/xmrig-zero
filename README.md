...
## Download
* Binary releases: https://github.com/jordan89m/xmrig-zero/releases
* Git tree: https://github.com/jordan89m/xmrig-zero.git
  * Clone with `git clone https://github.com/jordan89m/xmrig-zero.git` :hammer: [Build instructions](https://github.com/xmrig/xmrig/wiki/Build).
